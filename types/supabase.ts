  ...
  public: {
    Tables: {
      beacons: {
        ...
        Relationships: [
          {
            foreignKeyName: "beacons_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
      ...
      interactions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "interactions_target_beacon_id_fkey"
            columns: ["target_beacon_id"]
            isOneToOne: false
      ...
      matches: {
        ...
        Relationships: [
          {
            foreignKeyName: "matches_beacon_id_fkey"
            columns: ["beacon_id"]
            isOneToOne: false
            referencedRelation: "beacons"
            referencedColumns: ["id"]
